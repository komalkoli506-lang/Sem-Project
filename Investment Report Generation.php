...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $sql = "SELECT investment_name, amount, date 
            FROM investment 
  ...
  $pdf->SetAuthor('Investment Tracker');
  $pdf->SetTitle('Investment Report');
  $pdf->SetHeaderData('', 0, 'Investment Report', "User ID: $user_id\nPeriod: $startDate to $endDate");

  $pdf->AddPage();
  $pdf->SetFont('helvetica', '', 12);

  $html = '<h2>Investment Report</h2>';
  ...
  $pdfFileName = "investment_report_" . time() . ".pdf";
...
<head>
  ...
  <title>Investment Report Generation</title>
