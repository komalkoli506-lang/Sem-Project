...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  // Fetch user-specific data from the expense table
  $sql = "SELECT expense_category, expense_amount, expense_date 
            FROM expense 
  ...
  $pdf->SetHeaderData('', 0, 'Expense Report', "User ID: $user_id\nPeriod: $startDate to $endDate");
  ...
  $pdfFileName = "expense_report_" . time() . ".pdf";
